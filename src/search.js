...
function projectScopeFromHeading() {
  // Project scope is derived from a user document's first-level heading.
  // No candidate-specific project name is bundled with the public build.
  return "";
}

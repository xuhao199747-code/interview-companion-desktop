...
function normalizeAsrQuestionNoise(question = "") {
  // Keep this generic. Candidate-specific ASR corrections belong in the
  // local glossary that users upload through the application settings.
  return String(question || "").replace(/\s{2,}/gu, " ").trim();
}
